...
class Facebook_Api extends Facebook
{
	...
	public function getMe(array $fields=array())
	{
		...
		try
		{
			...
			//Logs::factory()->debugNew("fbuserwang",$this->me,$fields,1);
		}
		catch(Exception $e)
		{
		    $this->me = array();
			//Logs::factory()->debugNew("fbuserwang",2,$e->getMessage(),$e->getCode());
		}
...
(
   ...
   **/
   public function getUserPerms($uid = null) {
	 ...
	 /**
	 * 发送FEED
	 * @author functions 2012-10-22 https://developers.facebook.com/docs/reference/api/ message, picture, link, name, caption, description, source, place, tags
	 * @param $linkurl 连接地址
	 * @param $feedpic 图片地址
